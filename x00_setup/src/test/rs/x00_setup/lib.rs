...
//!
//! ## Allowed lints
//! - `dead_code`: permits unused functions, structs, or impls
//! - `unused_variables`: permits variables that are declared but not used
//! - `unused_imports`: permits imports that are not referenced
//! - `unused_parens`: permits unnecessary parentheses
//!
